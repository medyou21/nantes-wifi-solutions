...
export default function Footer() {
    ...
    return (
      ...
      >
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 0.75 }}>
          <Box sx={{ width: 6, height: 6, borderRadius: "50%", background: "#00C853",
  ...
  return (
    ...
    >
      {/* Top line décorative */}
      <Box sx={{ position: "absolute", top: 0, left: 0, width: "100%", lineHeight: 0, pointerEvents: "none" }}>
        <svg viewBox="0 0 1440 60" preserveAspectRatio="none" style={{ width: "100%", height: "60px" }}>
          <path d="M0,20 C360,60 1080,0 1440,40" fill="none" stroke="rgba(0,140,255,0.9)" strokeWidth="2.5" />
          <path d="M0,20 C360,60 1080,0 1440,40" fill="none" stroke="rgba(0,140,255,0.25)" strokeWidth="8" />
        </svg>
      </Box>
      ...
      <Box sx={{
        ...
        background: "rgba(0,100,255,0.08)", filter: "blur(80px)",
      ...
      <Box sx={{ position: "relative", zIndex: 1, maxWidth: 1100, mx: "auto" }}>
        ...
        <Box sx={{
          ...
          <Box>
            ...
            <Typography sx={{
              ...
              lineHeight: 1.7, mb: 3, maxWidth: 260,
            }}>
              Expert Wi-Fi à Nantes. Diagnostic, installation et sécurisation
              de vos réseaux pour particuliers et professionnels.
            </Typography>
        ...
        {/* Divider */}
        <Box sx={{ width: "100%", height: "1px", background: "rgba(255,255,255,0.07)", mb: 3 }} />
        ...
        <Box sx={{
          ...
          <Box sx={{ display: "flex", gap: 3, flexWrap: "wrap", justifyContent: "center" }}>
            {legalLinks.map((link) => (
              <Box key={link.label} component={Link} to={link.to} sx={{
